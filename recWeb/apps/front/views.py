...
class ChowView(views.MethodView):
    def get(self):
...
class SearchView(views.MethodView):
    def get(self):
        return render_template('front/search_index.html')
...
bp.add_url_rule('/shop/', view_func=ChowView.as_view('shop'))
bp.add_url_rule('/suggest/', view_func=SearchView.as_view('suggest'))
